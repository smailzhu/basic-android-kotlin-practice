...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val (textActionResId, lemonTreeResId) = when (lemonadeState) {
            ...
            else -> Pair(R.string.lemon_empty_glass, R.drawable.lemon_restart)
        }
